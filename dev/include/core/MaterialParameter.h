...
namespace ld3d
{
	...
	typedef boost::shared_ptr<MaterialParameterBool>		MaterialParameterBoolPtr;
	typedef boost::shared_ptr<MaterialParameterInt>			MaterialParameterIntPtr;
	typedef boost::shared_ptr<MaterialParameterFloat>		MaterialParameterFloatPtr;
	typedef boost::shared_ptr<MaterialParameterFloat2>		MaterialParameterFloat2Ptr;
	typedef boost::shared_ptr<MaterialParameterFloat3>		MaterialParameterFloat3Ptr;
	typedef boost::shared_ptr<MaterialParameterFloat4>		MaterialParameterFloat4Ptr;
	typedef boost::shared_ptr<MaterialParameterFloat4x4>	MaterialParameterFloat4x4Ptr;
	typedef boost::shared_ptr<MaterialParameterTexture>		MaterialParameterTexturePtr;
