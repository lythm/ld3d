...
struct qt_meta_stringdata_Form_Preview_t {
    QByteArrayData data[1];
    char stringdata[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Form_Preview_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_Form_Preview_t qt_meta_stringdata_Form_Preview = {
    {
...
const QMetaObject Form_Preview::staticMetaObject = {
    { &QMdiSubWindow::staticMetaObject, qt_meta_stringdata_Form_Preview.data,
      qt_meta_data_Form_Preview,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Form_Preview.stringdata))
        return static_cast<void*>(const_cast< Form_Preview*>(this));
    if (!strcmp(_clname, "Ui::Form_Preview"))
        return static_cast< Ui::Form_Preview*>(const_cast< Form_Preview*>(this));
